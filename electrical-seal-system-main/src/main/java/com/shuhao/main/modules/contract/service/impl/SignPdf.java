...
public class SignPdf {
    ...
    public static byte[] sign(String password, String keyStorePath, String signPdfSrc, String signImage,
                              float x, float y,int p,float w, float h ){
        ...
        try {
            ...
            // 是对应x轴和y轴坐标
            sap.setVisibleSignature(new Rectangle(x, y, x + w, y + h), p,
    ...
    public static void main(String[] args) throws Exception {
        byte[] fileData = sign("123456", "D:\\pdf\\keystore.p12",
                "D:\\pdf\\111.pdf",
                "D:\\pdf\\sign.jpg", 200, 200, 1,150,150);
        FileOutputStream f = new FileOutputStream(new File("D:\\pdf\\signed.pdf"));
        f.write(fileData);
        f.close();
    }
}